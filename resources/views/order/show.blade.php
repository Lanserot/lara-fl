...
@section('content')
    ...
    <div>
        ...
        <p class="mt-3">Категория : <a
                href="{{route('order.category', $order->category->name)}}">{{$order->category->name_rus}}</a></p>
        ...
        @elseif($response_code == Response::HTTP_FOUND)
