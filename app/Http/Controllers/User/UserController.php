...
class UserController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if($data[UserVO::KEY_PASSWORD] != $data['password_repeat']){
            return response()->json(['message' => 'Diff password'])->setStatusCode(HttpStatuses::NOT_BAD_REQUEST);
        }
        if ($validator->fails()) {
            ...
            return response()->json(['message' => $message])->setStatusCode(HttpStatuses::NOT_BAD_REQUEST);
        }
